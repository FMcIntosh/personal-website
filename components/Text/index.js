...
export const Title = withTheme()(({ theme, children, light }) => {
  ...
  return (
    <Typography type="title" align="center" gutterBottom style={style} color="default">
      {children}
    </Typography>
  );
});
...
export const Header = withTheme()(({ theme, children, light, gutter, style }) => {
  ...
  return (
    <Typography type="title" align="center" gutterBottom={gutter} style={styles} color="default">
      {children}
    </Typography>
  );
});
...
export const Paragraph = withTheme()(({ theme, children, light, style }) => {
  ...
  return (
    <Typography type="body1" align="center" gutterBottom style={styles}>
      {children}
    </Typography>
  );
});
